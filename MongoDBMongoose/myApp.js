...
mongoose.connect(process.env.MONGO_URI);
    ...
    /** # SCHEMAS and MODELS #mongodb+srv://monp:<password>@cluster0.vgg5w.mongodb.net/<dbname>?retryWrites=true&w=majority
/*  ====================== */
...
var createAndSavePerson = function(done) {
  var youngBlood = new Person({name: "Young Blood", age:21, favoriteFoods:["pizza","burger"]});
   youngBlood.save(function(err,data){
...
var arrayOfPeople = [
  {name:"Peppa", age:21, favoriteFoods:["Spaghetti"]},
  {name: "George", age:19, favoriteFoods:["Sandwiches"]},
  {name: "Danny",age:22, favoriteFoods:["Meatballs"]}
];
